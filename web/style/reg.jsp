            ...
            <table border="5" width="40%" cellpadding="12">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><center><input type="text" name="fname" value="" /></center></td>
                    </tr>
                    <tr>
                        <td><h3>LastName</h3></td>
                        <td><center><input type="text" name="lname" value="" /></center></td>
                    </tr>
                    <tr>
                        <td><h3>Email</h3></td>
                        <td><center><input type="text" name="email" value="" /></center></td>
                    </tr>
                    <tr>
                        <td><h3>UserName</h3></td>
                        <td><center><input type="text" name="uname" value="" /></center></td>
                    </tr>
                    <tr>
                        <td><h3>Password</h3></td>
                        <td><center><input type="password" name="pass" value="" /></center></td>
                    </tr>
                    <tr>
